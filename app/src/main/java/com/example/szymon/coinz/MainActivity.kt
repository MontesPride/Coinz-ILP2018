        ...
        for (feature in featureList!!) {
            ...
            icon = when (markerColor) {
                "#ff0000" -> when (markerSymbol) {
                    "0" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_0)
                    "1" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_1)
                    "2" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_2)
                    "3" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_3)
                    "4" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_4)
                    "5" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_5)
                    "6" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_6)
                    "7" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_7)
                    "8" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_8)
                    "9" -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker_9)
                    else -> IconFactory.getInstance(this).fromResource(R.drawable.red_marker)
                }
                "#008000" -> when (markerSymbol) {
                    "0" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_0)
                    "1" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_1)
                    "2" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_2)
                    "3" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_3)
                    "4" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_4)
                    "5" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_5)
                    "6" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_6)
                    "7" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_7)
                    "8" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_8)
                    "9" -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker_9)
                    else -> IconFactory.getInstance(this).fromResource(R.drawable.green_marker)
                }
                "#0000ff" -> when (markerSymbol) {
                    "0" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_0)
                    "1" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_1)
                    "2" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_2)
                    "3" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_3)
                    "4" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_4)
                    "5" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_5)
                    "6" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_6)
                    "7" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_7)
                    "8" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_8)
                    "9" -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker_9)
                    else -> IconFactory.getInstance(this).fromResource(R.drawable.blue_marker)
                }
                "#ffdf00" -> when (markerSymbol) {
                    "0" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_0)
                    "1" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_1)
                    "2" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_2)
                    "3" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_3)
                    "4" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_4)
                    "5" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_5)
                    "6" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_6)
                    "7" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_7)
                    "8" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_8)
                    "9" -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker_9)
                    else -> IconFactory.getInstance(this).fromResource(R.drawable.yellow_marker)
                }
                else -> IconFactory.getInstance(this).fromResource(R.drawable.purple_marker)
            }
